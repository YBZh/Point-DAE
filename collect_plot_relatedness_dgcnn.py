...
plot_relatedness_hardest(results_shapenet, results_downstream, save_name='shapenet_acc_scanhard_acc_human_pose_dgcnn')
...
def plot_relatedness_objbg(results_shapenet, results_downstream, save_name):
    ...
    for i in range(len(color_sorted_by_acc)):
        if corruptions_sorted_by_acc[i] == 'No-Corruption':
            ...
            ax.scatter(shapenet_acc_sorted[i], scanobj_acc_sorted_by_acc[i], s=800,
                       c=color_sorted_by_acc[i], marker=marker_sorted_by_acc[i])  # 'b^-', linewidth=8, ms=30, label="Acc")
    # ax.scatter(shapenet_acc_sorted, scanobj_acc_sorted_by_acc, s=800,
    #            c=color_sorted_by_acc, marker=marker_sorted_by_acc[1])  # 'b^-', linewidth=8, ms=30, label="Acc")
    # for i in range(shapenet_acc_sorted.size(0)):
    #     ax.annotate(corruptions_sorted_by_acc[i], xy=(shapenet_acc_sorted[i], scanobj_acc_sorted_by_acc[i]), \
    #                 xytext=(shapenet_acc_sorted[i], scanobj_acc_sorted_by_acc[i]), size=14)
    ### if some points are overlapped, then
    ...
    # ax.annotate('p =0.35', xy=(x_max, y_max), \
    #             xytext=(x_max- x_gap * 0.15, y_max), size=35)
    ax.annotate('r = 0.89', xy=(x_min, y_max), \
                xytext=(x_min, y_max), size=35)
    ax.annotate('p < .001', xy=(x_min, y_max-0.01), \
                xytext=(x_min, y_max-0.01), size=35)
    ax.plot(shapenet_acc_sorted_real, slope * shapenet_acc_sorted_real + intercept, 'k--', linewidth=5)
...
# results_downstream = collect_results(downstream_task_root, file_list, require_taskaffinity_in_name)
#
# plot_relatedness_objbg(results_shapenet, results_downstream, save_name='shapenet_acc_scanobjbg_acc_human_pose_dgcnn')
...
def plot_relatedness_modelnet(results_shapenet, results_downstream, save_name):
    ...
    # ax.annotate('p =0.35', xy=(x_max, y_max), \
    #             xytext=(x_max- x_gap * 0.15, y_max), size=35)
    ax.annotate('r = 0.96', xy=(x_min, y_max), \
                xytext=(x_min, y_max), size=35)
    ax.annotate('p < .001', xy=(x_min, y_max-0.003), \
                xytext=(x_min, y_max-0.003), size=35)
    ax.plot(shapenet_acc_sorted_real, slope * shapenet_acc_sorted_real + intercept, 'k--', linewidth=5)
    plt.tick_params(labelsize=40)
    ax.set_xlabel(r'Task Relatedness', fontsize=30)
    # ax.set_xlabel(r'Task Relatedness Measured By Loss', fontsize=30)
...
plot_relatedness_modelnet(results_shapenet, results_downstream, save_name='shapenet_acc_modelnet_acc_human_pose_dgcnn')
...
# shapenet_acc_scanobjbg_acc_human_pose_DGCNN
###############################################################################################
def plot_relatedness_loss_scanobjbg(results_shapenet, results_downstream, save_name):
    # ##################### For Point_MSR
    results_downstream[-4] = 0.844  #
    results_downstream[-3] = 0.848  ##
    ...
    adjust_text(texts,
                arrowprops=dict(arrowstyle="->", color='black', lw=1.2))
    ax.legend(loc='lower left', fontsize=20, markerscale=0.8)
    # ax.annotate('p =0.35', xy=(x_max, y_max), \
    #             xytext=(x_max- x_gap * 0.15, y_max), size=35)
    ax.annotate('r = - 0.69', xy=(x_max, y_max), \
                xytext=(x_max-0.04, y_max), size=35)
    ax.annotate('p = .002', xy=(x_max, y_max-0.008), \
                xytext=(x_max-0.04, y_max-0.008), size=35)
    ax.plot(shapenet_acc_sorted_real, slope * shapenet_acc_sorted_real + intercept, 'k--', linewidth=5)
    plt.tick_params(labelsize=40)
    # ax.set_xlabel(r'Task Relatedness', fontsize=30)
    ax.set_xlabel(r'Task Relatedness Measured By Loss', fontsize=30)
...
print(file_list)
results_downstream = collect_results(downstream_task_root, file_list, require_taskaffinity_in_name)
plot_relatedness_loss_scanobjbg(results_shapenet, results_downstream, save_name='shapenet_loss_scanobjbg_acc_human_pose_dgcnn')

######

# def plot_relatedness_loss_hardest(results_shapenet, results_downstream, save_name):
#     # ##################### For Point_MSR
#     # results_shapenet[1] = 0.89
#     results_downstream[-3] = 0.749  ##
#
...
#     ax.annotate('r = - 0.69', xy=(x_max, y_max), \
#                 xytext=(x_max-0.04, y_max), size=35)
#     ax.annotate('p = .002', xy=(x_max, y_max-0.01), \
#                 xytext=(x_max-0.04, y_max-0.01), size=35)
...
# print(file_list)
# results_downstream = collect_results(downstream_task_root, file_list, require_taskaffinity_in_name)
# plot_relatedness_loss_hardest(results_shapenet, results_downstream, save_name='shapenet_loss_scanhard_acc_human_pose_dgcnn')
