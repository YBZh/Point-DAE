...
def plot_relatedness_hardest(results_shapenet, results_downstream, save_name):
    ...
    ax.annotate('r = 0.70', xy=(x_min, y_max), \
...
plot_relatedness_hardest(results_shapenet, results_downstream, save_name='shapenet_acc_scanhard_acc_human_pose_pointnetnot_svd')
...
plot_relatedness_objbg(results_shapenet, results_downstream, save_name='shapenet_acc_scanobjbg_acc_human_pose_pointnetnot_svd')
...
plot_relatedness_modelnet(results_shapenet, results_downstream, save_name='shapenet_acc_modelnet_human_pose_pointnetnot_svd')
