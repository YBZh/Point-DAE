...
def plot_relatedness_scanhard(results_shapenet, results_downstream, save_name):
    ...
    ax.annotate('r = 0.91', xy=(x_min, y_max), \
                xytext=(x_min, y_max), size=35)
...
plot_relatedness_scanhard(results_shapenet, results_downstream, save_name='shapenet_acc_scanhard_acc_human_pose_pointnetv2_svd')
...
plot_relatedness_objbg(results_shapenet, results_downstream, save_name='shapenet_acc_scanobjbg_acc_human_pose_pointnetv2_svd')
...
plot_relatedness_modelnet(results_shapenet, results_downstream, save_name='shapenet_acc_modelnet_acc_human_pose_pointnetv2_svd')
