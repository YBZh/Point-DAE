...
class dgcnn_encoder_nopooling(nn.Module):
    def __init__(self, channel=3, **kwargs):
        super(dgcnn_encoder_nopooling, self).__init__()
        self.bn1 = nn.BatchNorm2d(64)
        self.bn2 = nn.BatchNorm2d(64)
        self.bn3 = nn.BatchNorm2d(128)
        self.bn4 = nn.BatchNorm2d(256)
...
## DGCNN classification and segmentation models are different!
## https://github.com/MohamedAfham/CrossPoint/blob/master/models/dgcnn.py
class dgcnn_encoder_partseg(nn.Module):
    def __init__(self, channel=3, **kwargs):
        super(dgcnn_encoder_partseg, self).__init__()
        self.bn1 = nn.BatchNorm2d(64)
        self.bn2 = nn.BatchNorm2d(64)
