...
from .dgcnn_util import dgcnn_encoder_partseg
...
class Point_CAE_DGCNN_PartSeg(nn.Module):
    def __init__(self, config):
        super().__init__()
        print_log(f'[Point_CAE_DGCNN_PartSeg] ', logger ='Point_CAE_DGCNN_PartSeg')
        self.config = config
...
@MODELS.register_module()
class Point_CAE_DGCNN_proj_PartSeg(nn.Module):
    def __init__(self, config):
        super().__init__()
...
@MODELS.register_module()
class DGCNN_Linear_PartSeg(nn.Module):
    def __init__(self, config, **kwargs):
        super().__init__()
        self.config = config
        self.cls_dim = config.cls_dim
...
# finetune model
@MODELS.register_module()
class DGCNN_feat_PartSeg(nn.Module):
    def __init__(self, config, **kwargs):
        super().__init__()
        self.config = config
        self.cls_dim = config.cls_dim
